      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Link href="/donor">
                <Button className="w-full bg-blue-600 hover:bg-blue-700">Access Donor Portal</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Link href="/hospital">
                <Button className="w-full bg-blue-600 hover:bg-blue-700">Access Hospital Portal</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow border-red-200">
            ...
            <CardContent>
              <Link href="/emergency">
                <Button className="w-full bg-red-600 hover:bg-red-700">Emergency Portal</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
